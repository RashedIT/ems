<template>
    <div class="container">
        <div class="row">
                <div class="col"></div>
                <div class="col">
                    <h1 class="mt-5 mb-5">Employee Log In </h1>
                    ...
                    <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                        ...
                        <div data-mdb-input-init class="form-outline mt-4 mb-4">
                            <label class="form-label mt-4" for="loginName">Email or username</label>
                            <input type="email" id="loginName" class="form-control" />
                        </div>

                        <!-- Password input -->
                        <div data-mdb-input-init class="form-outline mb-4">
                            <label class="form-label mt-4" for="loginPassword">Password</label>
                        ...
                        <router-link to="/EmployeeHomepage" class="btn btn-primary btn-block mb-4">Sign In</router-link><br>
  ...
  <script>
    export default {
        name: 'Employee-Login',
        mounted() {
            document.title = 'EMS: Employee Log In'
        }
    }
